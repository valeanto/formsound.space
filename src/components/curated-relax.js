      ...
      <div className="container">
        ...
        <div className="content">
          <div className="container-svg">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 181.65 138.03" className='relaxIcon' id='first'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 181.65 138.03" className='relaxIcon' id='second'>
              <g id="Layer_2" data-name="Layer 2">
                <g id="Ebene_1" data-name="Ebene 1">
                  <path
                    class="cls-1"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 181.65 138.03" className='relaxIcon' id='third'>
              <g id="Layer_2" data-name="Layer 2">
                <g id="Ebene_1" data-name="Ebene 1">
                  <path
                    class="cls-1"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 181.65 138.03" className='relaxIcon' id='fourth'>
              <g id="Layer_2" data-name="Layer 2">
                <g id="Ebene_1" data-name="Ebene 1">
                  <path
                    class="cls-1"
